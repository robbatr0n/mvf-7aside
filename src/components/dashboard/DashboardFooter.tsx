...
const STAT_GUIDE = [
  ...
  { abbr: "KP/G", name: "Key Passes per Game", desc: "Average key passes per game played" },
  ...
  { abbr: "GPG", name: "Goals per Game", desc: "Average goals scored per game played" },
  { abbr: "HT", name: "Hat Tricks", desc: "Number of games where the player scored 3 or more goals" },
  { abbr: "Win%", name: "Win Rate", desc: "Percentage of games played that resulted in a win" },
  ...
  { abbr: "──", name: "", desc: "" },
  { abbr: "PC", name: "Passes Completed", desc: "Passes successfully received by a teammate" },
  { abbr: "PF", name: "Passes Failed", desc: "Pass attempts that were incomplete or intercepted" },
  { abbr: "Att", name: "Pass Attempts", desc: "Passes completed + passes failed" },
  { abbr: "Acc%", name: "Pass Accuracy", desc: "Percentage of pass attempts that were completed (PC / Att)" },
  { abbr: "PC/G", name: "Passes Completed per Game", desc: "Average completed passes per game played" },
  { abbr: "──", name: "", desc: "" },
...
export default function DashboardFooter({ games }: Props) {
  ...
  return (
    <div className="border-t border-[#D4D3D0] dark:border-[#2a2e31] pt-8 space-y-4">
      <div className="bg-white dark:bg-[#111518] border border-[#D4D3D0] dark:border-[#2a2e31] rounded-2xl overflow-hidden">
        <button
